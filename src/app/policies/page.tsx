      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-8">
          <div className="px-4 py-5 sm:p-6">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">Sharing</h3>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">Security Precautions</h3>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">Data Deletion and Retention</h3>
            ...
            <p className="mb-4">You may access, rectify, and update your personal data directly through the functionalities provided on the Platform.</p>
            
            <h3 className="text-xl font-semibold mb-2 mt-4">Consent</h3>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">Changes to this Privacy Policy</h3>
            <p className="mb-4">Please check our Privacy Policy periodically for changes. We may update this Privacy Policy to reflect changes to our information practices. We may alert / notify you about the significant changes to the Privacy Policy, in the manner as may be required under applicable laws.</p>
            
            <h3 className="text-xl font-semibold mb-2 mt-4">Grievance Officer</h3>
            <p className="mb-4">Insert Name of the Office:<br />
            Designation:<br />
            Insert Name and Address of the Company:</p>
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-8">
          <div className="px-4 py-5 sm:p-6">
            ...
            <ol className="list-decimal pl-5 mb-4 space-y-2">
              ...
              <li>HUMAYA POWER does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that the quality of the product delivered is not good.</li>
              ...
              <li>In case of any refunds approved by HUMAYA POWER, it will take 7 days for the refund to be processed to you.</li>
            </ol>
          </div>
        </div>
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-8">
          <div className="px-4 py-5 sm:p-6">
            ...
            <p className="mb-4">We offer refund / exchange within first 14 days from the date of your purchase. If 14 days have passed since your purchase, you will not be offered a return, exchange or refund of any kind. In order to become eligible for a return or an exchange, (i) the purchased item should be unused and in the same condition as you received it, (ii) the item must have original packaging, (iii) if the item that you purchased on a sale, then the item may not be eligible for a return / exchange. Further, only such items are replaced by us (based on an exchange request), if such items are found defective or damaged.</p>
